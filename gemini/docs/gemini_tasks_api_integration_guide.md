...
To use the Gemini Tasks API, first obtain your API Token from the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) for future use.
...
> 📘 Complete Documentation: [Gemini Tasks API →](https://platform.acedata.cloud/documents/gemini-tasks)
