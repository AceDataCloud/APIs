...
| ---- | ---- | ------------ |
| [Veo Extend API Integration Instructions](https://platform.acedata.cloud/documents/veo-videos) | `/veo/extend` | [Veo Extend API Integration Instructions](docs/veo_extend_api_integration_guide.md) |
| [Veo Objects API Integration Instructions](https://platform.acedata.cloud/documents/veo-videos) | `/veo/objects` | [Veo Objects API Integration Instructions](docs/veo_objects_api_integration_guide.md) |
| [Veo Reshoot API Integration Instructions](https://platform.acedata.cloud/documents/veo-videos) | `/veo/reshoot` | [Veo Reshoot API Integration Instructions](docs/veo_reshoot_api_integration_guide.md) |
| [Veo Upsample API Integration Instructions](https://platform.acedata.cloud/documents/veo-videos) | `/veo/upsample` | [Veo Upsample API Integration Instructions](docs/veo_upsample_api_integration_guide.md) |
| [Veo Videos Generation API Integration Instructions](https://platform.acedata.cloud/documents/veo-videos) | `/veo/videos` | [Veo Videos Generation API Integration Instructions](docs/veo_videos_generation_api_integration_guide.md) |
| [Integration and Use of Veo Tasks API](https://platform.acedata.cloud/documents/veo-videos) | `/veo/tasks` | [Integration and Use of Veo Tasks API](docs/veo_tasks_api_integration_guide.md) |
