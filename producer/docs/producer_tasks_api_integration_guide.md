# Integration and Use of Producer Tasks API
...
This document will provide a detailed description of the integration of the Producer Tasks API, helping you easily integrate and fully utilize the powerful features of this API. With the Producer Tasks API, you can easily query the execution status of tasks from the Producer Audios Generation API.

## Application Process

To use the Producer Audios Generation API, first obtain your API Token from the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) for future use.
...
We will take a task ID returned by the Producer Audios Generation API as an example to demonstrate how to use this API. Suppose we have a task ID: 1a6ac2ad-10f2-4e2b-b500-66ec27fe82ad, and we will demonstrate how to pass in a task ID.
...
The returned result contains multiple fields, among which items include the specific details of the batch tasks, and the specific information of each task is the same as the format of the single task return result above. The field information is as follows.
...
Through this document, you have learned how to use the Producer Tasks API to query all specific details of single or batch tasks. We hope this document helps you better integrate and use the API. If you have any questions, please feel free to contact our technical support team.
