...
The returned result contains multiple fields, among which `items` includes the detailed information of batch tasks. Each task's specific information is the same as the fields described above. The field information is as follows.

- `items`: All detailed information of batch tasks. It is an array, and each element in the array has the same format as the single task query result described above.
- `count`: The number of batch query tasks here.
...
Through this document, you have learned how to use the Producer Tasks API to query all detailed information of single or batch tasks. We hope this document helps you better integrate and use the API. If you have any questions, please feel free to contact our technical support team.
