...
| Producer Lyrics Generation API | `/producer/lyrics` | [Producer Lyrics Generation API Integration Guide](docs/producer_lyrics_generation_api_integration_guide.md) |
...
| Producer Upload Reference Audio API | `/producer/upload` | [Producer Upload Reference Audio API Integration Guide](docs/producer_upload_reference_audio_api_integration_guide.md) |
| Producer Videos Download API | `/producer/videos` | [Producer Videos Download API Integration Guide](docs/producer_videos_download_api_integration_guide.md) |
| Producer WAV Download API | `/producer/wav` | [Producer WAV Download API Integration Guide](docs/producer_wav_download_api_integration_guide.md) |
