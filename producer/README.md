...
| [Producer Lyrics API](https://platform.acedata.cloud/documents/producer-lyrics) | `/producer/lyrics` | [Producer Lyrics API Integration Guide](docs/producer_lyrics_api_integration_guide.md) |
| [Producer Upload API](https://platform.acedata.cloud/documents/producer-upload) | `/producer/upload` | [Producer Upload API Integration Guide](docs/producer_upload_api_integration_guide.md) |
| [Producer Videos API](https://platform.acedata.cloud/documents/producer-videos) | `/producer/videos` | [Producer Videos API Integration Guide](docs/producer_videos_api_integration_guide.md) |
| [Producer WAV API](https://platform.acedata.cloud/documents/producer-wav) | `/producer/wav` | [Producer WAV API Integration Guide](docs/producer_wav_api_integration_guide.md) |
