# Art QR Code API Application and Usage
...
To use the art QR code API, you can first go to the [Art QR Code API](https://data.zhishuyun.com/documents/qrart-generate "Art QR Code API") page and click the "Get" button:
