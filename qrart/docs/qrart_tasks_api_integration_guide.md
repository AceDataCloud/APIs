# Integration and Use of Artistic QR Tasks API
...
To use Artistic QR Generation API, first open the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) and copy your API Token.
...
> 📘 Full documentation: [Artistic QR Generation API →](https://platform.acedata.cloud/documents/qrart-generate)

## Request Example

The Artistic QR Tasks API can be used to query the results of an API from the Artistic QR Generation API. For information on how to use the Artistic QR Generation API, please refer to the document [Artistic QR Generation API](https://platform.acedata.cloud/documents/qrart-generate).
