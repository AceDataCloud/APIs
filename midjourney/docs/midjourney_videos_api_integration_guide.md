...
If you want to continue generating an already created Midjourney video, you can set the parameter `action` to `extend` and input the ID of the video you want to continue generating. The video ID can be obtained based on the basic usage.
