...
The Midjourney Tasks API can be used to query the results of both the Midjourney Imagine API and the Midjourney Describe API. For information on how to use the Midjourney Imagine API, please refer to the documentation [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine). For information on how to use the Midjourney Describe API, please refer to [Midjourney Describe API](https://platform.acedata.cloud/documents/midjourney-describe).
