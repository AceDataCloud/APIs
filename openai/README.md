...
<div class="oa-api-card">
<h3>📋 Models</h3>
<p class="api-desc">List available OpenAI-compatible models.</p>
<span class="oa-api-path">/openai/models</span>
</div>
<div class="oa-api-card">
<h3>🗂️ Tasks</h3>
<p class="api-desc">Query asynchronous image generation and editing tasks.</p>
...
<p class="api-desc">Transcribe audio files to text.</p>
...
| [OpenAI Tasks API](docs/openai_tasks_api_integration_guide.md) | `/openai/tasks` | [OpenAI Tasks API Integration Guide](docs/openai_tasks_api_integration_guide.md) |
