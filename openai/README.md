...
| OpenAI Models API | `GET /openai/models` | API reference |
| OpenAI Audio Speech API | `POST /v1/audio/speech` | API reference |
| OpenAI Audio Transcriptions API | `POST /v1/audio/transcriptions` | API reference |
| OpenAI Realtime API | `GET /v1/realtime` | WebSocket connection; `model` is required and `voice` is optional |
