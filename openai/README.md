...
| ---- | ---- | ------------ |
| [OpenAI Chat Completion API Application and Usage](https://platform.acedata.cloud/documents/openai-chat-completions) | `/openai/chat/completions` | [OpenAI Chat Completion API Application and Usage](docs/openai_chat_completions_4o_image_api_integration_guide.md) |
| [OpenAI Chat Completion 4o Image API Application and Usage](https://platform.acedata.cloud/documents/openai-chat-completions) | `/openai/chat/completions` | [OpenAI Chat Completion 4o Image API Application and Usage](docs/openai_chat_completions_4o_image_api_integration_guide.md) |
| [OpenAI Embeddings API Application and Usage](https://platform.acedata.cloud/documents/openai-embeddings) | `/openai/embeddings` | [OpenAI Embeddings API Application and Usage](docs/openai_embeddings_api_integration_guide.md) |
| [OpenAI Images Edits API Application and Usage](https://platform.acedata.cloud/documents/openai-images-edits) | `/openai/images/edits` | [OpenAI Images Edits API Application and Usage](docs/openai_images_edits_api_integration_guide.md) |
| [OpenAI Images Generations API Application and Usage](https://platform.acedata.cloud/documents/openai-images-generations) | `/openai/images/generations` | [OpenAI Images Generations API Application and Usage](docs/openai_images_generations_api_integration_guide.md) |
| [OpenAI Responses API Application and Usage](https://platform.acedata.cloud/documents/openai-responses) | `/openai/responses` | [OpenAI Responses API Application and Usage](docs/openai_responses_api_integration_guide.md) |
| [OpenAI Tasks API Integration and Usage](https://platform.acedata.cloud/documents/openai-chat-completions) | `/openai/tasks` | [OpenAI Tasks API Integration and Usage](docs/openai_tasks_api_integration_guide.md) |
