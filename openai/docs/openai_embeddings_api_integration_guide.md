...
OpenAI embeddings service, used to generate embedding vectors that represent the input text.
...
- `model`, the model used for generating the embeddings.
- `usage`, the token information used for generating the embeddings.
- `data`, the embedding results after the text conversion.
...
Through this document, you have learned how to easily use the official OpenAI embeddings generation with the OpenAI Embeddings API. We hope this document can help you better integrate and use the API. If you have any questions, please feel free to contact our technical support team.
