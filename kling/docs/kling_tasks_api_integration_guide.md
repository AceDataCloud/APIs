...
The Kling Tasks API can be used to query the results of the Kling Videos Generation API. For information on how to use the Kling Videos Generation API, please refer to the document [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos).
...
![](https://cdn.acedata.cloud/xztiqi.png)
...
![](https://cdn.acedata.cloud/bsqh3i.png)
...
![](https://cdn.acedata.cloud/4p5uvq.png)

### Code Example

You can see that various language codes have been automatically generated on the right side of the page, as shown in the image below:

![](https://cdn.acedata.cloud/g3b7g6.png)
