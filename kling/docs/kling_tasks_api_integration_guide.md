...
To use the Kling Videos Generation API, first obtain your API Token from the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) for future reference.
...
The Kling Tasks API can be used to query the results of the Kling Videos Generation API. For information on how to use the Kling Videos Generation API, please refer to the documentation [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos).
...
The returned result contains multiple fields, among which `items` includes the detailed information of batch video tasks. Each video's specific information has the same fields as described above. The field descriptions are as follows.

- `items`: All detailed information of batch video tasks. It is an array, and each element in the array has the same format as the single task query result described above.
...
Through this document, you have learned how to use the Kling Tasks API to query all detailed information of single or batch video tasks. We hope this document helps you better integrate and use this API. If you have any questions, please feel free to contact our technical support team.
