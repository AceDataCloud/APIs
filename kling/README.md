...
The Kling Lip Sync API generates a lip-synced video by driving a source video with an audio file or synthesized speech from text.

The Kling Talking Photo API animates a portrait image to produce a talking-head video synchronized with a provided audio file.
