...
Kling AI video generation service with text-to-video, image-to-video, and motion transfer capabilities.

![Platform](https://img.shields.io/badge/platform-Ace%20Data%20Cloud-0f766e?style=flat-square) ![API](https://img.shields.io/badge/type-AI%20API-2563eb?style=flat-square) ![Docs](https://img.shields.io/badge/docs-online-16a34a?style=flat-square)

API home page: [Ace Data Cloud - Kling](https://platform.acedata.cloud/service/kling)

Keywords: kling-api, ai-video, video-generation, text-to-video, image-to-video, motion-generation, rest-api, ai-api, developer-tools, AI API, REST API, Developer API, Ace Data Cloud

## Why Use Kling on Ace Data Cloud
...
The Kling Videos Generation API generates official Kling AI videos by inputting custom parameters such as prompt, action, model, and optional reference images or videos. It supports text-to-video, image-to-video, and video extension actions across multiple Kling models.

The Kling Tasks API queries the execution status of tasks by inputting the task ID generated by the Kling Videos Generation API.

The Kling Motion Generation API generates videos with motion transfer by providing a reference image and reference video, allowing the character's motion in the video to match the reference.
...
- Service page: [Kling on Ace Data Cloud](https://platform.acedata.cloud/service/kling)
