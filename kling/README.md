...
Keywords: kling-ai, ai-video, video-generation, text-to-video, image-to-video, motion-control, lip-sync, talking-photo, rest-api, ai-api, aivideo, AI API, REST API, Developer API, Ace Data Cloud
...
The Kling Lip Sync API drives an existing Kling video (5s or 10s) with audio or text so the character speaks in sync, enabling talking-photo and digital-human narration pipelines.

The Kling Talking Photo API turns a single portrait photo and audio file into a talking video in one call, internally combining image2video animation with lip-sync.
...
| [Kling Lip Sync API](https://platform.acedata.cloud/documents/kling-lip-sync) | `/kling/lip-sync` | [Kling Lip Sync API Integration Guide](docs/kling_lip_sync_api_integration_guide.md) |
| [Kling Talking Photo API](https://platform.acedata.cloud/documents/kling-talking-photo) | `/kling/talking-photo` | [Kling Talking Photo API Integration Guide](docs/kling_talking_photo_api_integration_guide.md) |
