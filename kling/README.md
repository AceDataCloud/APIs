...
The Kling Lip Sync API synchronizes a character's lip movements in a video to a provided audio track or synthesized speech, supporting both audio-to-video and text-to-video modes.

The Kling Talking Photo API animates a portrait image into a talking-head video, synchronizing the character's lip movements to a provided audio track.
