# Suno Tasks API Integration and Usage
...
To use the Suno Audios Generation API, first go to the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) to obtain your API Token for future use.
...
Upon successful request, the API will return the detailed information of the song task here. For example:
```json
{
