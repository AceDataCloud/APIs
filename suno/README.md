...
| ---- | ---- | ------------ |
| [Suno Song Generation API Integration Instructions](https://platform.acedata.cloud/documents/suno-audios) | `/suno/audios` | [Suno Song Generation API Integration Instructions](docs/suno_audios_generation_api_integration_guide.md) |
| [Suno Lyrics Generation API Integration Instructions](https://platform.acedata.cloud/documents/suno-lyrics) | `/suno/lyrics` | [Suno Lyrics Generation API Integration Instructions](docs/suno_lyrics_generation_api_integration_guide.md) |
| [Suno Mashup Lyrics Generation API Integration Instructions](https://platform.acedata.cloud/documents/suno-mashup-lyrics) | `/suno/mashup-lyrics` | [Suno Mashup Lyrics Generation API Integration Instructions](docs/suno_mashup_lyrics_generation_api_integration_guide.md) |
| [Suno MIDI Generation API Integration Instructions](https://platform.acedata.cloud/documents/suno-audios) | `/suno/midi` | [Suno MIDI Generation API Integration Instructions](docs/suno_midi_api_integration_guide.md) |
| [Suno MP4 API Integration Instructions](https://platform.acedata.cloud/documents/suno-audios) | `/suno/mp4` | [Suno MP4 API Integration Instructions](docs/suno_mp4_api_integration_guide.md) |
| [Suno Custom Singer Style API Integration Instructions](https://platform.acedata.cloud/documents/suno-audios) | `/suno/persona` | [Suno Custom Singer Style API Integration Instructions](docs/suno_persona_api_integration_guide.md) |
| [Suno Style API Integration Instructions](https://platform.acedata.cloud/documents/suno-audios) | `/suno/style` | [Suno Style API Integration Instructions](docs/suno_style_api_integration_guide.md) |
| [Suno Timing API Integration Guide](https://platform.acedata.cloud/documents/suno-audios) | `/suno/timing` | [Suno Timing API Integration Guide](docs/suno_timing_api_integration_guide.md) |
| [Suno Upload Reference Audio API Integration Instructions](https://platform.acedata.cloud/documents/suno-audios) | `/suno/upload` | [Suno Upload Reference Audio API Integration Instructions](docs/suno_upload_api_integration_guide.md) |
| [Suno Voice Cloning API Integration Instructions](https://platform.acedata.cloud/documents/suno-audios) | `/suno/voices` | [Suno Voice Cloning API Integration Instructions](docs/suno_voices_api_integration_guide.md) |
| [Suno Vox API Integration Instructions](https://platform.acedata.cloud/documents/suno-persona) | `/suno/vox` | [Suno Vox API Integration Instructions](docs/suno_vox_api_integration_guide.md) |
| [Suno Wav API Integration Guide](https://platform.acedata.cloud/documents/suno-audios) | `/suno/wav` | [Suno Wav API Integration Guide](docs/suno_wav_api_integration_guide.md) |
| [Suno Tasks API Integration and Usage](https://platform.acedata.cloud/documents/suno-audios) | `/suno/tasks` | [Suno Tasks API Integration and Usage](docs/suno_tasks_api_integration_guide.md) |
