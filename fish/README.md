...
| [Fish Model Create API](https://platform.acedata.cloud/documents/82dcabe9-b1a3-541f-80f1-decb183b920c) | `POST /fish/model` | [Fish Model Create API Integration Guide](docs/fish_model_api_integration_guide.md) |
