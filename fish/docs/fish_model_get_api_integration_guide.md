...
Simply replace the ID in the URL path with the specific voice ID. No query parameters or request body are needed.
...
- `404 not_found`: The specified voice ID does not exist or is not visible to the current account.
