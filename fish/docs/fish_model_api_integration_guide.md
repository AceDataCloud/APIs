...
- **Sample upload when creating a model**: This interface currently only supports submission in JSON format, passing audio sample URLs through the `voices` field. The URL method covers about 80% of common scenarios.
