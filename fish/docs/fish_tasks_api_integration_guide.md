...
<p><img src="https://cdn.acedata.cloud/jxvue8.png" width="500" /></p>
...
我们以 Fish Audios Generation API 服务返回的任务ID一个为例，演示如何使用该 API。假设我们有一个任务ID：2725a2d3-f87e-4905-9c53-9988d5a7b2f5，接下来演示如何通过传入一个任务ID来查询任务详情。
...
<p><img src="https://cdn.acedata.cloud/xc5ejq.png" width="500" /></p>

### 代码示例

可以发现，在页面右侧已经自动生成了各种语言的代码，如图所示：

<p><img src="https://cdn.acedata.cloud/851zv2.png" width="500" /></p>
...
这是针对多个任务ID来进行查询任务详情，与上面不同的是需要将action选中为retrieve_batch
...
<p><img src="https://cdn.acedata.cloud/64lid9.png" width="500" /></p>

### 代码示例

可以发现，在页面右侧已经自动生成了各种语言的代码，如图所示：

<p><img src="https://cdn.acedata.cloud/ezkzmw.png" width="500" /></p>
