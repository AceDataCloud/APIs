...
To use Grok Tasks API, first open the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) and copy your API Token.
...
> 📘 Full documentation: [Grok Tasks API →](https://platform.acedata.cloud/documents/grok-tasks)
